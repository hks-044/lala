...
if (isset($_POST['simpan'])) {
    ...
    if ($foto != "") {
        if (move_uploaded_file($tmp_foto, $path)) {
            $query = "INSERT INTO paket_haji (judul, tanggal_keberangkatan, durasi, harga, lokasi, deskripsi_haji, gambar) 
                      VALUES ('$judul', '$tanggal', '$durasi', '$harga', '$lokasi', '$deskripsi', '$nama_baru')";
            
            $result = mysqli_query($koneksi, $query);

            if ($result) {
                echo "<script>alert('Data berhasil disimpan!'); window.location='admin_haji.php';</script>";
            } else {
...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-menu">
            <li class="nav-item">
                <a href="admin_haji.php" class="nav-link"><i class="fas fa-arrow-left"></i> KEMBALI</a>
            </li>
        </ul>
    </aside>
                ...
                <div class="input-column">
                    ...
                    <div class="form-grid">
                        <div class="form-group full-width">
                            <label>Nama Paket Haji</label>
                            <input type="text" name="judul" placeholder="Contoh: Haji Furoda 2025 - Visa Mujamalah" required>
                        </div>

                        <div class="form-group">
                            <label>Lokasi / Hotel</label>
                            <input type="text" name="lokasi" placeholder="Mekkah (Zamzam Tower) - Madinah" required>
                        </div>

                        <div class="form-group">
                            <label>Durasi Program</label>
                            <input type="text" name="durasi" placeholder="25 Hari (Arbain)" required>
                        </div>

                        <div class="form-group">
                            <label>Harga (Rp)</label>
                            <input type="number" name="harga" placeholder="285000000" required>
                        </div>
                        ...
                        <div class="form-group full-width">
                            <label>Fasilitas & Itinerary Haji</label>
                            <textarea name="deskripsi" placeholder="Jelaskan fasilitas tenda Arafah, Maktab, dan itinerary..." required></textarea>
                            <p style="font-size:12px; color:#999; margin-top:5px;">Gunakan Enter untuk baris baru.</p>
                        </div>
                    </div>

                    <div class="btn-area">
                        <a href="admin_haji.php" class="btn-cancel">Batal</a>
