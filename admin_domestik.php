...
if (isset($_GET['cari'])) {
    $keyword = $_GET['cari'];
    // REVISI: Tabel paket_domestik
    $query = "SELECT * FROM paket_domestik WHERE judul LIKE '%$keyword%' ORDER BY id DESC";
} else {
    // REVISI: Tabel paket_domestik
    $query = "SELECT * FROM paket_domestik ORDER BY id DESC";
}
...
<head>
    ...
    <title>Admin - Kelola Paket Domestik</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item">
                <a href="admin_sejarah.php" class="nav-link"><i class="fas fa-landmark"></i> TOUR SEJARAH</a>
            </li>
            ...
            <li class="nav-item active"><a href="admin_domestik.php" class="nav-link"><i class="fas fa-map-location-dot"></i> DOMESTIK</a></li>
    ...
    <main class="main-content">
        ...
        <div class="top-bar">
            <h2 class="page-title">Wisata Halal Domestik Indonesia</h2>
        ...
        <div class="content-header">
            <h1>Daftar Paket</h1>
            <a href="admin_domestiktambah.php" class="btn-add"><i class="fas fa-plus"></i> Tambah Paket</a>
        </div>
        ...
        <div class="card-grid">
            ...
            <div class="admin-card">
                ...
                <div class="action-overlay">
                    <a href="admin_domestikedit.php?id=<?= $row['id']; ?>" class="btn-action btn-edit" title="Edit">
                        <i class="fas fa-pencil-alt"></i>
                    </a>
                    <a href="admin_domestikhapus.php?id=<?= $row['id']; ?>" class="btn-action btn-delete" title="Hapus" onclick="return confirm('Yakin ingin menghapus paket ini?');">
