...
$id = $_GET['id'];
// REVISI: paket_sejarah -> paket_umrah
$query = "SELECT * FROM paket_umrah WHERE id = '$id'";
...
if (!$data) {
    ...
    header("Location: admin_umrah.php");
}
...
if (isset($_POST['update'])) {
    ...
    if ($foto != "") {
        ...
        $query_update = "UPDATE paket_umrah SET 
                         judul = '$judul', 
                         tanggal_keberangkatan = '$tanggal', 
                         durasi = '$durasi', 
                         harga = '$harga', 
                         lokasi = '$lokasi', 
                         deskripsi_umrah = '$deskripsi', 
                         gambar = '$nama_baru' 
                         WHERE id = '$id'";
    } else {
    ...
    if ($run_update) {
        // REVISI: admin_sejarah.php -> admin_umrah.php
        echo "<script>alert('Data Berhasil Diupdate!'); window.location='admin_umrah.php';</script>";
    } else {
...
<body>
    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <div class="breadcrumb">Dashboard > Umrah > Edit > <?= $data['judul']; ?></div>
        </div>
                ...
                <div class="input-column">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="deskripsi" required><?= $data['deskripsi_umrah']; ?></textarea>
