...
// 2. AMBIL DATA DARI TABEL PAKET INTERNASIONAL
...
<title>Paket Wisata Internasional - HKSyari Trip</title>
...
<body>
  ...
  <header class="navbar">
      ...
      <ul class="nav-links">
          ...
          <li><a href="#contactinter">Contact</a></li>
  ...
  <div class="wrap">
          ...
          Paket Wisata Halal Internasional<br>
          <span style="font-size:22px; color:#475569; font-weight:500;">
            جولات سياحية دولية حلال
          </span>
        </h2>

        <p style="color:#475569;margin-bottom:18px; text-align:center;">
          Nikmati liburan keliling dunia ke destinasi favorit dengan jaminan makanan halal dan waktu sholat yang terjaga.
        </p>
                  ...
                  <div class="info-inner">
                    ...
                    <div class="meta meta-deskripsi">
                      ...
                      <ul style="margin:6px 0 0 0; padding-left: 15px; list-style-type: disc;">
                        <?php
                            // REVISI: Mengambil data dari kolom deskripsi_internasional
                            $deskripsi_mentah = $row['deskripsi_internasional'];
                            
                            // Membersihkan dan memecah baris baru menjadi list
...
<div id="contactinter" class="scroll-target">
