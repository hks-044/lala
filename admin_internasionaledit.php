...
$id = $_GET['id'];
// REVISI: Tabel paket_internasional
$query = "SELECT * FROM paket_internasional WHERE id = '$id'";
$result = mysqli_query($koneksi, $query);
$data = mysqli_fetch_assoc($result);

// Jika ID tidak ditemukan, kembalikan ke admin
if (!$data) {
    // REVISI: Redirect ke admin_internasional
    header("Location: admin_internasional.php");
}
...
if (isset($_POST['update'])) {
    ...
    // LOGIKA GANTI GAMBAR
    if ($foto != "") {
        // A. Jika Admin Upload Gambar Baru
        ...
        $query_update = "UPDATE paket_internasional SET 
                         judul = '$judul', 
                         tanggal_keberangkatan = '$tanggal', 
                         durasi = '$durasi', 
                         harga = '$harga', 
                         lokasi = '$lokasi', 
                         deskripsi_internasional = '$deskripsi', 
                         gambar = '$nama_baru' 
                         WHERE id = '$id'";
    } else {
        // B. Jika Tidak Ganti Gambar
        // REVISI: Tabel paket_internasional & kolom deskripsi_internasional
        $query_update = "UPDATE paket_internasional SET 
                         judul = '$judul', 
                         tanggal_keberangkatan = '$tanggal', 
    ...
    if ($run_update) {
        ...
        echo "<script>alert('Data Berhasil Diupdate!'); window.location='admin_internasional.php';</script>";
    } else {
...
<head>
    ...
    <title>Edit Paket Internasional</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    
    <style>
        /* --- CSS SERAGAM DENGAN DASHBOARD & ADMIN --- */
        :root { 
            --sidebar-bg: #0c8c70;         
            --main-bg: #F5F7FA;            
            --accent-gold: #C89F30;        
...
<body>
    ...
    <main class="main-content">
        <div class="page-header">
            <h1>Edit Paket Internasional</h1>
            <div class="breadcrumb">Dashboard > Internasional > Edit > <?= $data['judul']; ?></div>
        </div>
                ...
                <div class="input-column">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="deskripsi" required><?= $data['deskripsi_internasional']; ?></textarea>
