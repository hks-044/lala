...
if (isset($_POST['simpan'])) {
    ...
    $harga    = $_POST['harga'];
    $lokasi   = $_POST['lokasi'];
    $deskripsi = $_POST['deskripsi']; // Diambil dari name="deskripsi" di form
    ...
    if ($foto != "") {
        if (move_uploaded_file($tmp_foto, $path)) {
            // REVISI: Tabel paket_domestik & Kolom deskripsi_domestik
            $query = "INSERT INTO paket_domestik (judul, tanggal_keberangkatan, durasi, harga, lokasi, deskripsi_domestik, gambar) 
                      VALUES ('$judul', '$tanggal', '$durasi', '$harga', '$lokasi', '$deskripsi', '$nama_baru')";
            
            $result = mysqli_query($koneksi, $query);

            if ($result) {
                // REVISI: Redirect ke admin_domestik.php
                echo "<script>alert('Data berhasil disimpan!'); window.location='admin_domestik.php';</script>";
            } else {
...
<head>
    ...
    <title>Tambah Paket Domestik</title>
...
<body>
    ...
    <main class="main-content">
        <div class="page-header">
            <h1>Tambah Paket Domestik</h1>
            <div class="breadcrumb">Dashboard > Domestik > Baru</div>
        </div>
                ...
                <div class="input-column">
                    ...
                    <div class="form-grid">
                        <div class="form-group full-width">
                            ...
                            <input type="text" name="judul" placeholder="Contoh: Explore Bali & Nusa Penida" required>
                        </div>

                        <div class="form-group">
                            <label>Lokasi</label>
                            <input type="text" name="lokasi" placeholder="Bali, Lombok, Labuan Bajo" required>
                        </div>

                        <div class="form-group">
                            <label>Durasi</label>
                            <input type="text" name="durasi" placeholder="4 Hari 3 Malam" required>
                        </div>

                        <div class="form-group">
                            <label>Harga (Rp)</label>
                            <input type="number" name="harga" placeholder="3500000" required>
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="deskripsi" placeholder="Tuliskan destinasi wisata dan fasilitas..." required></textarea>
