...
$id = $_GET['id'];
$query = "SELECT * FROM paket_haji WHERE id = '$id'";
...
if (isset($_POST['update'])) {
    ...
    if ($foto != "") {
        ...
        $query_update = "UPDATE paket_haji SET 
                         judul = '$judul', 
                         tanggal_keberangkatan = '$tanggal', 
                         durasi = '$durasi', 
                         harga = '$harga', 
                         lokasi = '$lokasi', 
                         deskripsi_haji = '$deskripsi', 
                         gambar = '$nama_baru' 
                         WHERE id = '$id'";
    } else {
    ...
    if ($run_update) {
        echo "<script>alert('Data Berhasil Diupdate!'); window.location='admin_haji.php';</script>";
    } else {
                ...
                <div class="input-column">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="deskripsi" required><?= $data['deskripsi_haji']; ?></textarea>
