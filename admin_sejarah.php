...
if (isset($_GET['cari'])) {
    ...
    $query = "SELECT * FROM paket_sejarah WHERE judul LIKE '%$keyword%' ORDER BY id DESC";
} else {
...
<body>
    ...
    <main class="main-content">
        ...
        <div class="top-bar">
            <h2 class="page-title">Tour Sejarah Islam</h2>
        ...
        <div class="content-header">
            <h1>Daftar Paket</h1>
            <a href="admin_sejarahtambah.php" class="btn-add"><i class="fas fa-plus"></i> Tambah Paket</a>
        </div>
        ...
        <div class="card-grid">
            ...
            <div class="admin-card">
                ...
                <div class="action-overlay">
                    <a href="admin_sejarahedit.php?id=<?= $row['id']; ?>" class="btn-action btn-edit" title="Edit">
                        <i class="fas fa-pencil-alt"></i>
                    </a>
                    <a href="admin_sejarahhapus.php?id=<?= $row['id']; ?>" class="btn-action btn-delete" title="Hapus" onclick="return confirm('Yakin ingin menghapus paket ini?');">
