...
if (isset($_GET['cari'])) {
    ...
    $query = "SELECT * FROM paket_umrah WHERE judul LIKE '%$keyword%' ORDER BY id DESC";
} else {
...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-menu">
            ...
            <li class="nav-item active"><a href="admin_umrah.php" class="nav-link"><i class="fas fa-mosque"></i>UMRAH</a></li>
    ...
    <main class="main-content">
        ...
        <div class="content-header">
            <h1>Daftar Paket</h1>
            <a href="admin_umrahtambah.php" class="btn-add"><i class="fas fa-plus"></i> Tambah Paket</a>
        </div>
        ...
        <div class="card-grid">
            ...
            <div class="admin-card">
                ...
                <div class="action-overlay">
                    <a href="admin_umrahedit.php?id=<?= $row['id']; ?>" class="btn-action btn-edit" title="Edit">
                        <i class="fas fa-pencil-alt"></i>
                    </a>
                    <a href="admin_umrahhapus.php?id=<?= $row['id']; ?>" class="btn-action btn-delete" title="Hapus" onclick="return confirm('Yakin ingin menghapus paket ini?');">
