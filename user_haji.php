...
<body>
  ...
  <header class="navbar">
      ...
      <ul class="nav-links">
          ...
          <li><a href="#contacthaji">Contact</a></li>
  ...
  <div class="wrap">
        ...
        <p style="color:#475569;margin-bottom:18px; text-align:center;">
          Tunaikan panggilan suci ke Baitullah dengan kenyamanan fasilitas VIP dan bimbingan ibadah sesuai sunnah demi kekhusyukan yang paripurna.<br>
        </p>
                  ...
                  <div class="info-inner">
                    ...
                    <div class="meta meta-deskripsi">
                      ...
                      <ul style="margin:6px 0 0 0; padding-left: 15px; list-style-type: disc;">
                        <?php
                            $deskripsi_mentah = $row['deskripsi_haji'];
...
<div id="contacthaji" class="scroll-target">
