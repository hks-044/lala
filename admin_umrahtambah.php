...
if (isset($_POST['simpan'])) {
    ...
    if ($foto != "") {
        if (move_uploaded_file($tmp_foto, $path)) {
            // REVISI: paket_sejarah -> paket_umrah DAN deskripsi_sejarah -> deskripsi_umrah
            $query = "INSERT INTO paket_umrah (judul, tanggal_keberangkatan, durasi, harga, lokasi, deskripsi_umrah, gambar) 
                      VALUES ('$judul', '$tanggal', '$durasi', '$harga', '$lokasi', '$deskripsi', '$nama_baru')";
            
            $result = mysqli_query($koneksi, $query);

            if ($result) {
                // REVISI: admin_sejarah.php -> admin_umrah.php
                echo "<script>alert('Data berhasil disimpan!'); window.location='admin_umrah.php';</script>";
            } else {
...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul class="nav-menu">
            <li class="nav-item">
                <a href="admin_umrah.php" class="nav-link"><i class="fas fa-arrow-left"></i> KEMBALI</a>
            </li>
        </ul>
    </aside>
    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <div class="breadcrumb">Dashboard > Umrah > Baru</div>
        </div>
                ...
                <div class="input-column">
                    ...
                    <div class="form-grid">
                        <div class="form-group full-width">
                            ...
                            <input type="text" name="judul" placeholder="Contoh: Umrah Akbar 9 Hari" required>
                        </div>

                        <div class="form-group">
                            <label>Lokasi</label>
                            <input type="text" name="lokasi" placeholder="Contoh: Mekkah, Madinah, Jeddah" required>
                        </div>

                        <div class="form-group">
                            <label>Durasi</label>
                            <input type="text" name="durasi" placeholder="Contoh: 9 Hari" required>
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="deskripsi" placeholder="Tuliskan fasilitas hotel, pesawat, dan kegiatan ibadah..." required></textarea>
                            <p style="font-size:12px; color:#999; margin-top:5px;">Gunakan Enter untuk baris baru.</p>
                        </div>
                    </div>

                    <div class="btn-area">
                        <a href="admin_umrah.php" class="btn-cancel">Batal</a>
