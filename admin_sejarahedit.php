...
$id = $_GET['id'];
$query = "SELECT * FROM paket_sejarah WHERE id = '$id'";
...
if (isset($_POST['update'])) {
    ...
    if ($foto != "") {
        ...
        $query_update = "UPDATE paket_sejarah SET 
                         judul = '$judul', 
    ...
    if ($run_update) {
        echo "<script>alert('Data Berhasil Diupdate!'); window.location='admin_sejarah.php';</script>";
    } else {
                ...
                <div class="input-column">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="deskripsi" required><?= $data['deskripsi_sejarah']; ?></textarea>
